...
export class SqlScratchService {
  ...
  public updateActiveScratchContent(content: string, projectId: string): boolean {
    return this.scratchesStore.updateActiveScratchContent(content, projectId);
  }
  ...
  public updateScratch(id: string, data: { name?: string; content?: string }, projectId: string) {
