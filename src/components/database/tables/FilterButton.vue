<script setup lang="ts">
  ...
  function clearFilters() {
    const hadActiveFilter = dataTableStore.activeFilter || dataTableStore.filterTerm;
  ...
  <div class="relative flex items-center gap-2">
    <div class="input-group flex gap-2">
      ...
      <button
        class="btn btn-sm"
        :class="{
          'btn-base-300': !dataTableStore.activeFilter && !dataTableStore.filterTerm,
          'btn-primary border-primary': dataTableStore.activeFilter || dataTableStore.filterTerm,
        }"
      ...
      <fieldset class="fieldset">
        ...
        <label class="label">
          <span class="label-text-alt text-xs">
            Examples:
            <code class="bg-base-300 cursor-pointer p-1" @click="setExampleFilter('id = 2')"
              >id = 2</code
            >,
            <code
