<script setup lang="ts">
  ...
  function goToPage() {
    ...
    if (!isNaN(page) && page >= 1 && page <= maxPage && page !== dataTableStore.currentPage) {
  ...
  >
    <div class="mb-2 flex items-center sm:mb-0">
      ...
      <div class="ml-4 flex space-x-2">
        <div class="tooltip tooltip-top" data-tip="Export">
          <button
            v-if="dataTableStore.tableData.length > 0"
    ...
    <div class="flex items-center space-x-2">
      <div class="join">
        ...
        <div class="join-item btn btn-xs btn-disabled">
          <span class="text-xs"> {{ dataTableStore.currentPage }} / {{ totalPages }} </span>
        </div>

        <button
          class="join-item btn btn-xs"
          :class="{
            'btn-disabled': dataTableStore.currentPage === totalPages,
          }"
