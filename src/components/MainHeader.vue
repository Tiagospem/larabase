...
<template>
	...
	>
		...
		<div class="flex">
			<div class="mr-2 border-r border-black/10 pr-2">
				...
				<div
					class="tooltip tooltip-bottom"
					data-tip="View application logs and errors"
				>
					<button
						class="btn btn-ghost btn-sm"
				...
				>
					...
					>
						...
						>
							{{
								props.pendingMigrations > 99
									? '99+'
									: props.pendingMigrations
							}}
						</span>
					</button>
				</div>
				...
				<div
					class="tooltip tooltip-bottom"
					data-tip="Edit .env configuration"
				>
					<button
						class="btn btn-ghost btn-sm"
				...
				>
					<button
						class="btn btn-ghost btn-sm"
						@click="ui.showDatabaseDiagram = true"
					>
						<svg
							class="h-4 w-4"
							fill="currentColor"
	...
	<ERDModal
		:show="ui.showDatabaseDiagram"
		@close="ui.showDatabaseDiagram = false"
	/>
