...
const { databaseSchema, isLoading, error, fetchDatabaseSchema } =
	useDatabaseSchema();
...
const initCytoscape = () => {
	...
	const positionTooltip = (node: any) => {
		...
		tooltipEl.style.left =
			containerBounds.left + renderedPosition.x + 90 + 'px';
		tooltipEl.style.top =
			containerBounds.top + renderedPosition.y - 80 + 'px';
	};
		...
		<div class="flex h-[80vh] flex-col space-y-4">
			<div class="flex items-center justify-between">
				...
				<div class="flex space-x-2">
					...
					<button
						...
						class="btn btn-sm"
						:class="{
							'btn-ghost': !selectedNode,
							'btn-primary': selectedNode
						}"
			...
			>
				<div class="alert alert-info">
					...
					<span
						>No database tables found. Ensure your database
						connection is properly configured.</span
					>
				</div>
			</div>
			...
			<div class="bg-base-200 rounded-md p-2 text-xs">
				...
				<div class="flex flex-wrap gap-x-4 gap-y-2">
					...
					<div class="flex items-center">
						<div
							class="mr-1 h-3 w-3 rounded-sm bg-indigo-500"
						></div>
						<span>Related Table</span>
					</div>
					<div class="flex items-center">
						<div
							class="mr-1 h-3 w-3 rounded-full border border-gray-400"
						></div>
						<span>Relationship</span>
					</div>
					<div class="flex items-center">
						<div
							class="mr-1 h-3 w-3 rounded-full border border-2 border-blue-500"
						></div>
				...
				<div class="mt-2 text-xs opacity-70">
					<span
						>Click on a table to see its relationships. Click again
						to deselect.</span
					>
				</div>
			</div>
