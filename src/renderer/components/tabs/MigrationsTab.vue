    ...
    <div class="flex-1 overflow-auto">
      ...
      <div v-else-if="loadError" class="flex items-center justify-center h-full text-error">
        <div class="text-center">
          ...
          <p>{{ loadError }}</p>
          <button class="btn btn-sm btn-primary mt-4" @click="loadMigrations">
            Try again
          </button>
        </div>
      </div>
      ...
      <div v-else-if="migrations.length === 0" class="flex items-center justify-center h-full text-gray-500">
        <div class="text-center">
          ...
          <button v-if="connection?.projectPath" class="btn btn-sm btn-ghost mt-4" @click="loadMigrations">
            Reload
          </button>
        </div>
      </div>
          ...
          >
            ...
            <div class="collapse-title font-medium flex items-center justify-between">
              <div class="flex items-center gap-2">
                <div class="w-3 h-3 rounded-full" :class="getMigrationStatusDotClass(migration.status)" />
    ...
    <div v-if="selectedMigration" class="modal modal-open">
      <div class="modal-box w-11/12 max-w-5xl max-h-[90vh]">
        ...
        <div class="modal-action">
          <button class="btn" @click="selectedMigration = null">
            Close
          </button>
        </div>
      </div>
