    ...
    <div class="flex-1 overflow-auto">
      ...
      <div v-else-if="loadError" class="flex items-center justify-center h-full text-error">
        <div class="text-center">
          ...
          <p>{{ loadError }}</p>
          <button class="btn btn-sm btn-primary mt-4" @click="loadForeignKeys">
            Try again
          </button>
        </div>
      </div>
      
      <div v-else-if="foreignKeys.length === 0" class="flex items-center justify-center h-full text-gray-500">
        <div class="text-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          <button class="btn btn-sm btn-ghost mt-4" @click="loadForeignKeys">
            Reload
          </button>
        </div>
      </div>
