<template>
  <div class="h-full flex flex-col">
    ...
    <div class="flex-1 overflow-auto">
      ...
      <div v-else-if="!modelFound" class="flex items-center justify-center h-full text-gray-500">
        <div class="text-center">
          ...
          <button v-if="connection?.projectPath" class="btn btn-sm btn-ghost mt-4" @click="loadModel">Reload</button>
        </div>
      </div>
            ...
            <div class="mt-2">
              <div class="flex flex-col space-y-3">
                <div class="flex items-start">
                  ...
                  <div class="flex-1">{{ model.namespace || 'Not specified' }}</div>
                </div>
                
                <div class="flex items-start">
                  <div class="w-28 font-medium text-gray-400">Full Name</div>
                  <div class="flex-1 font-mono text-sm bg-base-300 p-1 rounded">{{ model.fullName }}</div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="flex-1 flex items-center gap-2">
                    ...
                    <button class="btn btn-xs btn-ghost" @click="openFileInEditor(model.path)" title="Open in editor">
    ...
    <div v-if="showJsonModal" class="modal modal-open">
      ...
      <div class="modal-backdrop" @click="showJsonModal = false"></div>
    </div>
  </div>
</template>
