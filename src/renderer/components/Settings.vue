<template>
          ...
          <div class="card-body space-y-4">
            ...
            <div class="form-control">
              <label class="label cursor-pointer">
                ...
                <input type="checkbox" v-model="settingsData.devMode" class="toggle toggle-primary" />
              </label>
            </div>
            
            <div v-if="settingsData.devMode" class="mt-4">
              <button @click="showStorageData = true" class="btn btn-sm btn-outline">
  ...
  <div v-if="showStorageData" class="modal modal-open z-40">
    ...
    <div class="modal-backdrop" @click="showStorageData = false"></div>
  </div>
</template>
