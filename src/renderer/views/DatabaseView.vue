<template>
    ...
    <header class="bg-neutral px-4 py-2 border-b border-neutral flex items-center justify-between">
      ...
      <div class="flex">
        ...
        <div class="border-r border-neutral-700 pr-2 mr-2">
          <button class="btn btn-ghost btn-sm" @click="showDatabaseInsights = true" title="Database Insights">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" 
              stroke="currentColor" class="w-5 h-5">
  ...
  <DatabaseInsights
    :is-open="showDatabaseInsights"
    :connection-id="connectionId"
    @close="showDatabaseInsights = false"
  />
</template>
...
import DatabaseInsights from '../components/DatabaseInsights.vue';
...
const showDatabaseInsights = ref(false);
